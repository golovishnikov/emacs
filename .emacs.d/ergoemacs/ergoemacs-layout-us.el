...
; Kill line
(defconst ergoemacs-kill-line-key			(kbd "C-M-x"))
(defconst ergoemacs-kill-line-backward-key		(kbd "C-M-X"))
...
(defconst ergoemacs-execute-extended-command-key	(kbd "<f5>"))
(defconst ergoemacs-shell-command-key			(kbd "M-A"))

;;; WINDOW SPLITING
(defconst ergoemacs-move-cursor-next-pane-key		(kbd "M-q"))
(defconst ergoemacs-move-cursor-previous-pane-key	(kbd "M-Q"))
...
(defconst ergoemacs-select-text-in-quote-key            (kbd "C-M-*"))
